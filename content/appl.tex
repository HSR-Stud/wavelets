...
\begin{tabular}{l||l|l|l|l|l|l}
	Eigenschaft 		& haar 	& dbN 	& symN 	& coifN	& biorNr.Nd	& rbioNd.Nr	\\
	\hline
	\hline
...
\begin{tabular}{l||m{0.3\textwidth}|m{0.3\textwidth}|m{0.3\textwidth}}
	Type & Scalingfunction $\Phi$ & Wavelet $\Psi$ & Filtercoeffs\\
	\hline
	haar & 
...
\lstinputlisting{content/waveDecRecSelf.m}

\subsubsection{Denoising}
DWT:

Mit konstantem Sigma über alle Level:
\lstinputlisting{content/denoise.m}

Mit angepasstem Sigma pro Level:
\lstinputlisting{content/estimateSigmaByLevel.m}
\lstinputlisting{content/denoiseGivenSigma.m}

SWT:
\lstinputlisting{content/stationaryWaveletTransform.m} %TODO dose not work!
\lstinputlisting{content/denoiseSwt.m}
...
\lstinputlisting{content/derivative.m}
